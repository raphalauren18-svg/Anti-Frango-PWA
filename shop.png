...
function openAdmin() {
  ...
  // Render then show (avoids flash of un-rendered content)
  initAdminPanel();
  panel.style.cssText = 'display:block; position:fixed; inset:0; z-index:10000; background:var(--color-bg); overflow:hidden;';
  document.body.style.overflow = 'hidden';
}
